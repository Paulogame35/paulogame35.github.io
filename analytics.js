...
(function () {
  ...
  function apply(record) {
    ...
    window.dispatchEvent(new CustomEvent('nexora:consentchange', { detail: { version: VERSION, analytics: allowed, advertising: false } }));
  }
  ...
  function mount() {
    ...
    panel.innerHTML = '<h2 id="privacy-heading" tabindex="-1">Sua privacidade, sua escolha</h2>' +
      ...
      '<p>Recusar não limita as ferramentas. Não há anúncios. Sua escolha fica neste navegador por até 180 dias e pode ser retirada no rodapé.</p>' +
  ...
  window.nexoraConsent = Object.freeze({ open, get: () => ({ analytics: choice?.analytics === true, advertising: false, version: VERSION }) });
  apply(readChoice());
